encoding = 'utf-8'
from os.path.playback import *
import numpy as np
import time
from os.path.compute_distance import *
...
robot_events_result = robot_events_tuple
...
for arr in arr2:
    ...
    all_sum += get_arr_distance(location1)
    print(get_arr_distance(location1))
...
print(sum)'''
# sum = get_all_distance(location2)
# print(all_sum)
end_time = time.time()
